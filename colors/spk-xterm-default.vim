"Name: spk-xterm-default -- Sporniket theme, port of default nvim highlight
"Description: Reference highlight settings
...
"[[Overview]]
"
"I exported the output of ':highlight' command, then translated each line into
"the proper 'highlight' command.
"
"This theme is meant to be the starting point to a custom color scheme by me.
"
"[[Guidelines]]
"
"I extracted this theme by redirecteing the output of ':highlight' to a file, while
"using the default color theme, in Ubuntu with 'Yaru' theme. Then I converted each 
"line into a proper highlight setting.

hi clear
let g:colors_name = 'spk-xterm-default'
